 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://model.hotelWebService.ibty.fr/", wsdlLocation = "http://localhost:8080/Hotel1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://model.hotelWebService.ibty.fr/", "HotelService");
    ...
    public IHotelService getHotelPort() {
        return super.getPort(new QName("http://model.hotelWebService.ibty.fr/", "HotelPort"), IHotelService.class);
    }
    ...
    public IHotelService getHotelPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://model.hotelWebService.ibty.fr/", "HotelPort"), IHotelService.class, features);
    }
