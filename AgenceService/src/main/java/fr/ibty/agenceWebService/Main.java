package fr.ibty.agenceWebService;
...
import fr.ibty.agenceWebService.model.Agence;
import fr.ibty.agenceWebService.model.Hotel;
import fr.ibty.agenceWebService.model.Offre;
...
public class Main {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		System.out.println("Hello, selectionnez une agence:");
		...
		System.out.println("Entrez vos coordonées : nom ?");
		String nom = "";
		do {
			nom = sc.nextLine();
		}while (nom.equals(""));	
		System.out.println("Entrez vos coordonées : prenom ?");
		String prenom = "";
		do {
			prenom = sc.nextLine();
		}while (prenom.equals(""));
		System.out.println("Entrez vos coordonées : carte ?");
		String carte = "";
		do {
			carte = sc.nextLine();
		}while (carte.equals(""));
